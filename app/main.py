...
from app.routes import km_avulso as km_avulso_router
from app.routes import checklist_vistoria as vistoria_router
...
app.include_router(km_avulso_router.router)
app.include_router(vistoria_router.router)
